...
export default function Login() {
    const [accounts] = useState(getSavedAccounts());
    ...
    return (
        <div className="justify-centerp-4 flex min-h-screen items-center">
            <div className="w-full max-w-md space-y-6">
                <div className="rounded-lg bg-white/5 p-8 shadow">
                    ...
                    {error && (
                        <div className="mt-4 rounded-lg border-2 border-red-600 bg-red-700/20 p-3 text-sm text-red-600">
                            {error}
                        </div>
                    )}
